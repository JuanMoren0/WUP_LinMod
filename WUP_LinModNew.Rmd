...
In the data sheet above we can see more detailed   information inn relation of the Simulation and Grip and   once again explaining 46% of the data.  
...
Taking the prediction data from above we can added to our   graph and see that there is a slight linear relation ship   with the scatter plot but it is not one that cant be seen   right in the beggining.  
